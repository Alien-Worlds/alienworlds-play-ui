...
const BlockchainSubmitDisclaimerModal = () => {
  const {
  ...
  const handleClose = () => {
    setSecondaryModalActive({ modalName: 'BlockchainSubmitDisclaimerModal', value: false })
  }
  ...
  return (
    <Modal isOpen={secondaryModals.BlockchainSubmitDisclaimerModal} onClose={() => handleClose()}>
...
export { BlockchainSubmitDisclaimerModal }
